...
public class DataUtil
{
    ...
    {
        return String.format("<a class=\"ariva\" href=\"https://www.ariva.de/search/search.m?searchname=%s\" target=\"_blank\"><img src=\"http://192.168.178.31:9080/stocksserver/api/stocks/image?isin=%s&path=%s\" class=\"table-chart-image\"/ style=></a>",
                             isin,
                             isin,
                             timeSpan.label);
    }
    ...
    {
        return String.format("<a class=\"onvista\" href=\"https://www.onvista.de/aktien/%s\" target=\"_blank\"><img src=\"http://192.168.178.31:9080/stocksserver/api/stocks/image?isin=%s&path=%s\" class=\"table-chart-image\"/ style=></a>",
                             shortUrl,
                             isin,
                             timeSpan.label);
    }
    ...
    public static String createOnVistaLink(String isin, String shortUrl)
    {
        ...
        return String.format("<a class=\"onvista\" href=\"https://www.onvista.de/aktien/%s\" target=\"_blank\">%s</a>",
                             s,
                             isin);
    }
    ...
    {
        return String.format("<a class=\"finanzen-net\"href=\"https://www.finanzen.net/suchergebnis.asp?strSuchString=%s\" target=\"_blank\">%s</a>",
                             isin,
                             name);
    }
    ...
    public static String getChartImageWithFinanzNetLink(String isin, TIMESPAN timeSpan)
    {
        ...
        return String.format("<a class=\"finanzen-net\" href=\"https://www.finanzen.net/suchergebnis.asp?strSuchString=%s\" target=\"_blank\"><img src=\"http://192.168.178.31:9080/stocksserver/api/stocks/image?isin=%s&path=%s\" class=\"table-chart-image\"/ style=></a>",
                             isin,
                             isin,
                             timeSpan.label);
    }
