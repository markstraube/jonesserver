...
public class SwingTradeCandidate
{
    ...
    public LiquidityFilter getLiquidity()
    {
        return liquidity;
    }


    public void setLiquidity(LiquidityFilter liquidity)
    {
        this.liquidity = liquidity;
    }


    public StockTrendFilter getTrend()
    {
        return trend;
    }


    public void setTrend(StockTrendFilter trend)
    {
        this.trend = trend;
    }


    public PullbackFilter getPullback()
    {
        return pullback;
    }


    public void setPullback(PullbackFilter pullback)
    {
    ...
    public void setVolume(VolumeFilter volume)
    {
        this.volume = volume;
    }


    public SupportFilter getSupport()
    {
        return support;
    }


    public void setSupport(SupportFilter support)
    {
        this.support = support;
    }


    public RiskRewardFilter getRiskReward()
    {
        return riskReward;
    }


    public void setRiskReward(RiskRewardFilter riskReward)
    {
        this.riskReward = riskReward;
    }


    public EventFilter getEvents()
    {
        return events;
    }


    public void setEvents(EventFilter events)
    {
        this.events = events;
    }
