...
{
    /**    
    * Relative Stärke nach Levy (RSL) Indikator.
    * period:
        6 Monate (ca. 126 Handelstage): Standard in vielen Momentum-Studien
        12 Monate (ca. 252 Handelstage): Für längerfristiges Momentum
        3 Monate (ca. 63 Handelstage): Für kurzfristigeres Momentum
    * Benchmark-Vergleich:
    * benchmarkPrices
        Für deutsche Aktien: DAX oder HDAX
        Für US-Aktien: S&P 500
        Für globale Portfolios: MSCI World  
        
    * Beispiel: Aktien auswählen mit hohem Momentum
        if (rsl > 1.05 &&      // 5% Outperformance vs. Benchmark
            adx > 25 &&        // Starker Trend
            roc > 10)          // Positive kurzfristige Entwicklung
        {
            // Kaufsignal
        }
    *
