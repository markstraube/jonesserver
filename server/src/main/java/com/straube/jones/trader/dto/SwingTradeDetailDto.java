...
public class SwingTradeDetailDto
{
    ...
    public TrendSection getTrend()
    {
        return trend;
    }


    public void setTrend(TrendSection trend)
    {
        this.trend = trend;
    }


    public PullbackSection getPullback()
    {
        return pullback;
    }


    public void setPullback(PullbackSection pullback)
    {
        this.pullback = pullback;
    }


    public SupportSection getSupport()
    {
        return support;
    }


    public void setSupport(SupportSection support)
    {
        this.support = support;
    }


    public RiskSection getRisk()
    {
        return risk;
    }


    public void setRisk(RiskSection risk)
    {
        this.risk = risk;
    }
