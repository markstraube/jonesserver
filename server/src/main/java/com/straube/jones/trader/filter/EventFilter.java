...
public class EventFilter
{
    ...
    /**
     * Nächstes Quartalszahlen-Datum. Quelle: Unternehmenskalender
     */
    private LocalDate nextEarningsDate;

    /**
     * Nächstes Dividenden-Datum. Quelle: Börse / Unternehmen
     */
    private LocalDate nextDividendDate;

    /**
     * Anzahl Handelstage bis zu den nächsten Earnings. Berechnung: Börsentage zwischen heute und
     * Earnings-Datum
     */
    ...
    public int getTradingDaysUntilEarnings()
    {
        return tradingDaysUntilEarnings;
    }


    public void setTradingDaysUntilEarnings(int tradingDaysUntilEarnings)
    {
        this.tradingDaysUntilEarnings = tradingDaysUntilEarnings;
    }
}
