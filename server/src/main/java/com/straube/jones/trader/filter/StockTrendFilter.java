...
public class StockTrendFilter
{
    ...
    /**
     * Aktueller Schlusskurs der Aktie. Quelle: Börse
     */
    private double closePrice;

    /**
     * 50-Tage-Durchschnitt. Wird häufig als Trendlinie genutzt. Berechnung: Durchschnitt der letzten 50
     * Schlusskurse
     */
    private double sma50;

    /**
     * 200-Tage-Durchschnitt. Langfristige Trendlinie.
     */
    private double sma200;

    /**
     * Gibt an, ob der mittelfristige Trend steigt. Berechnung: sma50_heute > sma50_vor_5_Tagen
     */
    private boolean sma50Rising;

    /**
     * Letztes markantes Hoch im Kursverlauf. Quelle: Aus Kursdaten abgeleitet (Swing-High)
     */
    ...
    public boolean isSma50Rising()
    {
        return sma50Rising;
    }


    public void setSma50Rising(boolean sma50Rising)
    {
        this.sma50Rising = sma50Rising;
    }
    ...
    public double getPreviousSwingHigh()
    {
        return previousSwingHigh;
    }


    public void setPreviousSwingHigh(double previousSwingHigh)
    {
        this.previousSwingHigh = previousSwingHigh;
    }
