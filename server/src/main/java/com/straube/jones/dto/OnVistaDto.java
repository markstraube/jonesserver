...
public class OnVistaDto {
    ...
    public Double getDateLong() { return dateLong; }
    public void setDateLong(Double dateLong) { this.dateLong = dateLong; }
    ...
    public Double getPerf1Year() { return perf1Year; }
    public void setPerf1Year(Double perf1Year) { this.perf1Year = perf1Year; }
    
    public Double getPerf6Months() { return perf6Months; }
    public void setPerf6Months(Double perf6Months) { this.perf6Months = perf6Months; }
    
    public Double getPerf4Weeks() { return perf4Weeks; }
    public void setPerf4Weeks(Double perf4Weeks) { this.perf4Weeks = perf4Weeks; }
