...
public class BranchDataResponse 
{
    ...
    public Map<String, String> getDataPoints() { return dataPoints; }
    public void setDataPoints(Map<String, String> dataPoints) { this.dataPoints = dataPoints; }
    
    public DataSummary getSummary() { return summary; }
    public void setSummary(DataSummary summary) { this.summary = summary; }
    ...
    public static class DataSummary 
    {
        ...
        public String getAverageValue() { return averageValue; }
