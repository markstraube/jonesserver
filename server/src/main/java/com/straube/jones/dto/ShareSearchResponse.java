...
public class ShareSearchResponse 
{
    ...
    public static class StockMatch {
        ...
        public Double getCapitalization() { return capitalization; }
        public void setCapitalization(Double capitalization) { this.capitalization = capitalization; }
    ...
    public List<StockMatch> getStocks() { return stocks; }
    public void setStocks(List<StockMatch> stocks) { this.stocks = stocks; }
